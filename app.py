    ...
    for i in range(len(array)-1):
        ...
        for j in range(i + 1, len(array)):
            ...
            if first_num + second_num == target_sum:
                 return [first_num, second_num]#to see the result on your terminal you can use the print() function
    return []
...
def sumNums(array,targetSum):
    ...
    for num in array:
        if targetSum-num in nums:
            return [num, targetSum-num] #to see the result on your terminal you can use the print() function
        else:
            nums[num] = True
    return []
...
print(sumUpNums([-4,3,5,8,11,1,-1,6],10))
